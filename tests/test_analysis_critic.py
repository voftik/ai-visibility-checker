...
class AnalysisCriticTests(unittest.IsolatedAsyncioTestCase):
    async def test_critic_uses_independent_gemini_model_with_bounded_iteration(
        ...
        self.assertEqual(CRITIC_VERSION, "aiv-analysis-critic-v15")
    ...
    async def test_incomplete_review_repair_gets_full_audit_payload(
        self,
    ) -> None:
        ...
        self.assertEqual(repair_payload["audit_payload"], payload)
