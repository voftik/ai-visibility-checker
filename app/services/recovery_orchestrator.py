...
CHECK_ENTITY_CATALOG_SOURCE_BINDING_VALID = "entity_catalog_source_binding_valid"
CHECK_ENTITY_CATALOG_GROUNDING_FILTER_VALID = "entity_catalog_grounding_filter_valid"
